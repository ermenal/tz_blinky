...
#define FLASH_NSC_START 0x0801F800UL
#define FLASH_NSC_END   0x0801FFFFUL
#define FLASH_NS_START  0x08020000UL
#define FLASH_NS_END    0x0807FFFFUL
#define RAM_NS_START    0x20008000UL
#define RAM_NS_END      0x2000FFFFUL
...
// Configure SAU Region 0 for Non-Secure Callable Flash
  SAU->RNR  = 0;
  SAU->RBAR = FLASH_NSC_START & SAU_RBAR_BADDR_Msk;
  SAU->RLAR = (FLASH_NSC_END & SAU_RLAR_LADDR_Msk) | SAU_RLAR_NSC_Msk | SAU_RLAR_ENABLE_Msk;

// Configure SAU Region 1 for Non-Secure Flash
  SAU->RNR  = 1;
  SAU->RBAR = FLASH_NS_START & SAU_RBAR_BADDR_Msk;
  SAU->RLAR = (FLASH_NS_END & SAU_RLAR_LADDR_Msk) | SAU_RLAR_ENABLE_Msk;

// Configure SAU Region 2 for Non-Secure RAM
  SAU->RNR  = 2;
  SAU->RBAR = RAM_NS_START & SAU_RBAR_BADDR_Msk;
  SAU->RLAR = (RAM_NS_END & SAU_RLAR_LADDR_Msk) | SAU_RLAR_ENABLE_Msk;
...
// #if !defined(SL_TRUSTZONE_SECURE) && !defined(SL_TRUSTZONE_NONSECURE) && defined(__TZ_PRESENT)
